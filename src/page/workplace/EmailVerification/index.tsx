...
const EmailVerification = () => {
  ...
  const { sendVerifyEmail, isSending, isSendError } = useEmailSend();
  const { verifyEmail, isVerifying, isVerifySuccess, isVerifyError } = useEmailVerify();
  // Handle input change
        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold mb-2">
              {isVerifySuccess ? t('verifysuccess') : t('verifyEmail')}
            </h2>
